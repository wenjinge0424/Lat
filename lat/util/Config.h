...
/*family*/
#define PARSE_TABLE_FAMILY                                      @"Family"
#define PARSE_FAMILY_ADMIN                                     @"admin"
#define PARSE_FAMILY_NAME                                      @"name"
#define PARSE_FAMILY_ISBANNED                                      @"is_banned"
#define PARSE_FAMILY_AVATAR                                     @"avatar"
#define PARSE_FAMILY_POINTS                                     @"points"
#define PARSE_FAMILY_TOKENS                                     @"tokens"
#define PARSE_FAMILY_LEVEL                                      @"level"
#define PARSE_FAMILY_COINS                                      @"coins"
#define PARSE_FAMILY_PASSWORD                                      @"pwd"

/*game set*/
#define PARSE_TABLE_GAMESET                                     @"GameSet"
#define PARSE_GAMESET_OWNER                                     @"owner"
#define PARSE_GAMESET_USER                                      @"user"
#define PARSE_GAMESET_LEVELNUM                                  @"levelNum"
#define PARSE_GAMESET_GAMEDATA                                  @"gameData"
#define PARSE_GAMESET_SUBLEVEL                                  @"sublevel"
