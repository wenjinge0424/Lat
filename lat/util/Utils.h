...
+ (void) setImage:(UIImageView *)imgView imgFile:(PFFile *)imgFile withDefaultImage:(UIImage*)image;
...
+ (NSString*) getJsonFromDict:(NSMutableDictionary*)dataDict;
+ (NSMutableDictionary*) getDictFromJson:(NSString*)json;
@end
